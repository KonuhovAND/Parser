...
def extract_teams_from_match_text(match_text):
    ...
    KNOWN_TEAMS = [
        "Авангард", "Автомобилист", "Адмирал", "Ак Барс", "Амур", 
        "Барыс", "Динамо М", "Динамо Мн", "Лада", "Локомотив", 
        "Металлург Мг", "Нефтехимик", "СКА", "Салават Юлаев", 
        "Северсталь", "Сибирь", "Спартак", "Торпедо", "Трактор", 
        "ХК Сочи", "ЦСКА", "Шанхайские Драконы", "Южный Урал",
        "Омские Крылья"
    ]
